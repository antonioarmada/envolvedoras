// -- CONFIGURACIONES ----------------------------------
const String ESTA_VERSION="M_v6.3"; // 6.3 primera implentada en fabrica
const bool FORZAR_DEBUG= false;
unsigned long latidoTiempo = 500;
const byte DIR_I2C_DAC= 0x61; //0x60 para maquina 1 y 2, 0x61 para la 3
const int FUERZA_MAXIMA_FILM_POTENCIOMETRO = 18; // en fabrica cambiamos desde 7 para lograr mas fuerza
...
const float LIMITE_FUERZA_AYUDA_PELICULA= 1.8; // variar segun la maquina y la fuerza que quiera hacer el operario
